...
<body>
    <?php
        ...
        $mathangviewcao = $mh->laymathangviewcao();
    ...
    <section id="product">
        <div class="container">
            <a href="hot.php" style="text-decoration: none;">
                <h1 class="list-product-title ">SẢN PHẨM NỔI BẬT</h1>
            </a>
                <div class="product">
                    <div class="row">
                    <?php
                        foreach($mathangviewcao as $m):
                    ?>
